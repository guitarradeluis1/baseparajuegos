...
//_____________________________________________________
    public function parametros()
    {
       ...
       if(isset($id) && $id !="")
       {
           ...
           $parametros["controlador"] = "movimientos";
           $parametros["funcion"] = "";
           $parametros["carpeta"] = "movimientos";
...
public function vista($id)
{
    ...
    $datos = $parametros;
    #$datos["Mensaje_alerta"] = $mensaje;
    $datos["Salida"] = $this->movimientos_model->consulto($id);
    $this->load->view($parametros["estilo"],$datos);
    $this->load->view($parametros["menu"]);
    $this->load->view($parametros["carpeta"]."/".$parametros["funcion"], $datos);
    #$this->load->view("botones_menu");
...
//_____________________________________________________
public function lista($nombre, $selector = "")
{
    $datos = array();
    $parametros = $this->parametros();
    ...
    $datos["Salida"] = $this->movimientos_model->lista();
    $this->load->view($parametros["carpeta"]."/".$parametros["funcion"], $datos);
}
//_____________________________________________________
}
