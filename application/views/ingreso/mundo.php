...
<script src="<?php echo base_url('js/mundo/mundo.js');?>"></script>
...
//**********************************
function mas_puntos(tipo)
{
    jQuery.ajax
    ({
        type: "POST",
        url: "../../ingreso/actualiza_puntos/"+tipo,
        beforeSend: function()
        {
            $('#btn_cerrar_status').click();
        },
        success: function(msg)
        {
            var temp_var = {};
            temp_var.titulo = "Puntos";
            temp_var.mensaje = "Nuevo registro de puntos !";
            temp_var.funcion = "";// JSON.stringify
