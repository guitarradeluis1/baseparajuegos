...
class Objetotipo_model extends CI_Model
{
...
function todo()
{
	...
	$consulta = $this->db->get('objetotipo');
...
function todo_paginados($por_pagina,$segmento) 
{
    ...
    $consulta = $this->db->get('objetotipo',$por_pagina,$segmento);
    if($consulta->num_rows()>0)
    {
        foreach($consulta->result() as $fila)
        {
...
function nuevo($datos)
{
    ...
    $id = "";
    $this->db->insert('objetotipo', $datos); 
...
function actualizo($datos)
{
    ...
    return $this->db->update('objetotipo', $datos); 
}
//______________________________________________________________________
