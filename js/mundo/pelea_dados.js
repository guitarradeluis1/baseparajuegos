...
function create()
{
    ...
    {
        personaje = game.add.sprite( parseInt(370), parseInt(200), personaje_img.objeto.nombre.toString());
        //Animacion-------------------------------------------
    ...
    abrir_items();
    //Triangulo------------------------
    triangulo_def = game.add.sprite( parseInt(346), parseInt(187), `triangulo`);
