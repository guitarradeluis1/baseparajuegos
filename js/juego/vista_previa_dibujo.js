...
function create()
{
    ...
    if(imagenes.objeto.objetotipo.id == "1" || imagenes.objeto.objetotipo.id == "4" )
    {
        ...
        ejemplo.height = parseInt(imagenes.height);
        ejemplo.width = parseInt(imagenes.width);
        ejemplo.animations.add( imagenes.texto.toString(), eval(imagenes.cuadros), parseInt(imagenes.velocidad), true);
        ejemplo.animations.play(imagenes.texto.toString());
    }
    else if(imagenes.objeto.objetotipo.id == "2")
    {
